				...
				<div class="callbacks_container">
					<ul class="rslides callbacks callbacks1" id="slider4">
						<li class="callbacks1_on" style="display: block; float: left; position: relative; opacity: 1; z-index: 2; transition: opacity 500ms ease-in-out;">
							...
							<h3 style="color: white">DINAS TENAGA KERJA DAN TRANSMIGRASI PROVINSI LAMPUNG</h3>
							<p>Lorem ipsum dolor sit amet</p>
							</div>
						</li>
						<li class="" style="display: block; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out;">
							<div class="banner-info">
							  <h3 style="color: white">Ut enim ad minima veniam, quis nostrum exercitationem</h3>
							 <p>Lorem ipsum dolor sit amet</p>
							</div>
						</li>
						<li class="" style="display: block; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out;">
							<div class="banner-info">
							 <h3 style="color: white">At vero eos et accusamus et iusto odio dignissimos.</h3>
							<p>Lorem ipsum dolor sit amet</p>
							</div>	
						</li>
					</ul>
	   ...
	   <div class="container">
	        <div class="mag-inner">
			    <div class="col-md-8 mag-innert-left jghdl">
			    	<!-- <h3 style="font-family: Segoe Print;padding-top: 20px; padding-left: 20px">PROGRAM PEMAGANGAN KE JEPANG </h3> -->
					<div class="issues">
						...
						<!--/start-Technology-->
						 <div class="technology">
			              <h2 class="tittle"><i class="glyphicon glyphicon-hand-right" aria-hidden="true"></i>National</h2>
