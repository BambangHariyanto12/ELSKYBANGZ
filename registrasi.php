		...
		<div class="container">
			<div class="about-grids">
				<div class="col-md-8 about-grid-left">
					...
					<div class="input-group">
						<span style="padding-bottom: 15px;">FOTO</span>
						<input type="file" name="file" required="off">
						<b class="text-danger">max size file foto 500 KB</b>
					</div>
                    ...
                    <div style="padding-left: 0px; padding-top: 20px; padding-bottom: 30px;">
                    	  <button type="reset" class="btn btn-outline btn-danger" style="font-weight: bold;">HAPUS</button>
                           <button type="submit" class="btn btn-outline btn-success" style="font-weight: bold;">UPLOAD DATA</button>
